            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data['data'] != null) {
                  _isAtSite =
                      snapshot.data['data'][widget.currentUser.uid]['isOnSite'];
                  print('the state 1: $_isAtSite');
